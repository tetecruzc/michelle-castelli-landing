          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
            ...
            >
              ...
              <div className="relative">
                <Search className="absolute left-5 top-1/2 -translate-y-1/2 text-white/60 z-10 pointer-events-none" size={20} />
                <input
                  type="text"
                  placeholder={t.books.searchPlaceholder}
                  value={search}
                  onChange={(e) => setSearch(e.target.value)}
                  className="w-full pl-14 pr-6 py-4 rounded-full border border-white/10 bg-white/10 backdrop-blur-md text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-primary/80 transition-all shadow-inner text-lg"
                />
              </div>
            </motion.div>
          </div>
